...
const ROLES = {
  ...
  acc: {
    name: "Аккаунтинг",
    emoji: "💰",
    description: "Ты знаешь сколько стоит каждая печенька на корпоративе. Твои таблицы сходятся до копейки. Слово 'приблизительно' вызывает у тебя лёгкое недомогание. Когда UnitPay упал — ты уже пишешь мерчам. Работа не ждёт.",
