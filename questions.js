...
const ROLES = {
  ...
  dev: {
    name: "Разработка",
    emoji: "💻",
    description: "Твоя настоящая роль — разработка. Если ты уже тут — поздравляю. Если нет... стоит задуматься.",
    photo: "assets/role-dev.jpg"
  },
  ceo: {
    name: "Директор",
    emoji: "👑",
    description: "Твоя настоящая роль — директор. Если ты уже тут — поздравляю. Если нет... стоит задуматься.",
  ...
  mgr: {
    name: "Менеджер",
    emoji: "📋",
    description: "Твоя настоящая роль — менеджер. Если ты уже тут — поздравляю. Если нет... стоит задуматься.",
